...
- two vertices $u,v$ are **adjacent** if $\{u,v\}\in E$
  ...
  - an edge (_u_,_v_) is **incident on** vertices _u_ and _v_. In a directed graph, the terminology differentiates between the beginning and ending vertex of an edge. So edge (_u_,_v_) which **leaves** vertex _u_ is said to be **incident from** vertex _u_ and is **incident to** (or **enters**) vertex _v_
